...
try:
    ...
    from crops.crop_biomass import (  # noqa: E402
        _fill_missing_gc2f_units,
        _get_das_to_combine,
        _get_case_grainc_at_maturity,
        GC2F,
...
class TestFillMissingGc2fUnits:  # pylint: disable=too-many-public-methods
    ...
    def test_basic(self, mock_case):
        ...
        with redirect_stdout(f):
            case.cft_ds = _fill_missing_gc2f_units(case.cft_ds, var_list, e)
        ...
        assert case.cft_ds[var_missing_units].attrs["units_source"] == GC2F_UNITS_SOURCE_VAR
    ...
    def test_err_source_missing(self, mock_case):
        ...
        with pytest.raises(type(e)) as raised:
            _fill_missing_gc2f_units(case.cft_ds, var_list, e)
...
class TestGetDasToCombine:  # pylint: disable=too-many-public-methods
    ...
    def test_basic(self):
        ...
        units, result_da = _get_das_to_combine(case.cft_ds, case.name, var_list)
    ...
    def test_err_units_missing(self, mock_case):
        ...
        with pytest.raises(AssertionError):
            _get_das_to_combine(case.cft_ds, case.name, var_list)
    ...
    def test_masking(self):
        ...
        case.cft_ds, result_da = _get_das_to_combine(case.cft_ds, case.name, var_list)
...
class TestGetGrainCAtMaturity:  # pylint: disable=too-many-public-methods
    ...
    def test_basic(self, mock_case_grainc):
        ...
        f = io.StringIO()
        with redirect_stdout(f):
            case.cft_ds, var = _get_case_grainc_at_maturity(case.cft_ds, case.name)
    ...
    def test_ok_missing_seed(self, mock_case_grainc):
        ...
        expected_msg = "test_case: Missing grain C outputs for ['SEED']; including only ['FOOD']"
    ...
    def test_ok_missing_food(self, mock_case_grainc):
        ...
        expected_msg = "test_case: Missing grain C outputs for ['FOOD']; including only ['SEED']"
        assert expected_msg in f.getvalue()
